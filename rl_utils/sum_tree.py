...
class SumTree(object):
    ...
    def __len__(self):
        return self.data_pointer if not self.data_wrapped else self.capacity
...
class WeightedMemory(object):  # stored as ( s, a, r, s_ ) in SumTree
    """
